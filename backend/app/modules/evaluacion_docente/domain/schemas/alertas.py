...
from app.modules.evaluacion_docente.domain.entities.enums import AlertaEstado, Severidad, TipoAlerta
from app.shared.domain.schemas.common import BaseSchema, PaginatedItems
