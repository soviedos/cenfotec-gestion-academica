...
Usage::
    ...
    from app.modules.evaluacion_docente.application.parsing import parse_evaluacion
...
from app.modules.evaluacion_docente.application.parsing.constants import PARSER_VERSION
...
from app.modules.evaluacion_docente.application.parsing.extractors.comments import extract_comments
from app.modules.evaluacion_docente.application.parsing.extractors.courses import extract_courses
from app.modules.evaluacion_docente.application.parsing.extractors.header import extract_header
from app.modules.evaluacion_docente.application.parsing.extractors.metrics import extract_metrics
from app.modules.evaluacion_docente.application.parsing.schemas import ParsedEvaluacion, PeriodoData
...
from app.shared.domain.exceptions import ValidationError as DomainValidationError
...
def parse_evaluacion(pdf_bytes: bytes) -> ParseResult:
    ...
    if resumen_pct is None:
        ...
        from app.modules.evaluacion_docente.application.parsing.schemas import ResumenPorcentajes
...
def _detect_total_pages(pages_text: list[str]) -> int | None:
    ...
    from app.modules.evaluacion_docente.application.parsing.constants import FOOTER_PAGE_RE
