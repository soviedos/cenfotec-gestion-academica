...
from app.domain.schemas.query import (
    CommentEvidence,
    CommentSource,
    GeminiCallResult,
    MetricEvidence,
...
from app.infrastructure.external.prompt_templates import QUERY_USER_TEMPLATE, format_evidence_block
from app.infrastructure.repositories.gemini_audit import GeminiAuditRepository
