...
import { useQualitative } from "@/features/evaluacion-docente/hooks/use-qualitative";
import type { QualitativeFilters } from "@/features/evaluacion-docente/hooks/use-qualitative";
import { fetchFiltrosCualitativos } from "@/features/evaluacion-docente/lib/api/qualitative";
import type { FiltrosCualitativos } from "@/features/evaluacion-docente/types";
import { KpiCard } from "@/features/evaluacion-docente/components/dashboard/kpi-card";
import { SentimentChart } from "@/features/evaluacion-docente/components/sentimiento/sentiment-chart";
import { ThemeBarChart } from "@/features/evaluacion-docente/components/sentimiento/theme-bar-chart";
import { CommentTable } from "@/features/evaluacion-docente/components/sentimiento/comment-table";
import { QualitativeFilterBar } from "@/features/evaluacion-docente/components/sentimiento/qualitative-filter-bar";
import {
  QualitativeSkeleton,
  QualitativeEmpty,
  QualitativeError,
